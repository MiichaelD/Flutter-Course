...
class _ConverterRouteState extends State<ConverterRoute> {
  final _inputBorderRadius = BorderRadius.circular(2.0);
  ...
  Widget build(BuildContext context) {
    // DONE: Create the 'input' group of widgets. This is a Column that includes
    ...
    // TODO: Create the 'output' group of widgets.
    ...
    // DONE: Return the input, arrows, and output widgets, wrapped in a column
    return Padding(
      padding: _padding,
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.stretch,
